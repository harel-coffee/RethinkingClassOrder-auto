...
for i in {1..1}; do
  for order in optimal_supervised_wdist_nb_cl_10_beam_0_seed_1993_min_trans_v2 optimal_ssl_wdist_nb_cl_10_beam_0_seed_1993_min_trans_v2 optimal_supervised_mdled_nb_cl_10_beam_0_seed_1993_min_trans_v2 optimal_ssl_mdled_nb_cl_10_beam_0_seed_1993_min_trans_v2 optimal_semantic_wordnet_wup_nb_cl_10_beam_0_seed_1993_min_trans_v2; do
