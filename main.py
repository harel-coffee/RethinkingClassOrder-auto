...
if __name__ == '__main__':
    ...
    parser.add_argument('--baseline', type=str, default='fc', choices=['fc'])
    ...
    # rehearsal
    parser.add_argument('--memory_type', type=str, default='episodic', choices=['episodic', 'generative', 'none'])
    parser.add_argument('--num_exemplars', type=int, default=20)
    parser.add_argument('--selection_strategy', type=str, default='random',
                        help='[highest|lowest|highlow|random|feat_kmedoids|ori_kmeans|ori_kmedoids|herding|fixed]')
